...
class WindowConfigTest {
    ...
    @Test
    void testToSting() {
        WindowConfig<CountWindowState> config = WindowConfig.create(TimeUnit.MILLISECONDS.toNanos(1000), 2048, countRolloverStrategy);
        ...
        WindowConfig<CountAndTimeWindowState> config1 = WindowConfig.create(TimeUnit.MILLISECONDS.toNanos(1000), 1099, countAndTimeRolloverStrategy);
        assertEquals("WindowConfig(time=1s,count=1099)", config1.toString());
    }
