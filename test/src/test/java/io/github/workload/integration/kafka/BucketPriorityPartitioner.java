...
// Borrowed from https://community.aws/posts/prioritizing-event-processing-with-apache-kafka
            ...
            if (key instanceof String) {
                ...
                if (keyValueParts.length >= 1) {
                    ...
                    if (buckets.containsKey(bucketName)) {
                        ...
                        partition = fallback.partition(topic, key, keyBytes, value, valueBytes, cluster);
                    }
                }
            } else {
                partition = fallback.partition(topic, key, keyBytes, value, valueBytes, cluster);
